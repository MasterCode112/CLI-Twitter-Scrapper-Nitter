...
def scrape(since, until=None, words=None, to_account=None, from_account=None, mention_account=None, interval=5, lang=None,
    ...
    # ------------------------- Variables :
    # header of csv
    header = ['UserName', 'Handles', 'Timestamp', 'Text', 'Embedded_text', 'Emojis', 'Comments', 'Likes', 'Retweets',
    ...
    data = pd.DataFrame(data, columns = ['UserName', 'Handles', 'Timestamp', 'Text', 'Embedded_text', 'Emojis', 
